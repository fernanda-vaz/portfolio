    ...
    >
      <div className='bg-black w-11/12 md:w-1/2 h-4/5 md:h-[90%] overflow-hidden rounded-xl'>
        <div className='relative'>
          <button
            className='absolute top-4 right-4 bg-black size-8 rounded-full border border-fontColor-50/40 grid place-items-center text-fontColor-50'
          ...
          <Image
            ...
            width={300}
            height={300}
            className='w-full h-full aspect-video md:aspect-video object-cover object-center'
          />
          ...
          <div className='p-3'>
            ...
            <div className='flex py-3 items-center gap-4'>
              {selectedProject.techStack.map((tech, i) => (
                <span
                  key={i}
                  className='border px-2 py-1 border-fontColor-50/40 rounded-2xl text-sm'
                >
                  {tech}
                </span>
              ))}
            </div>
            <p className='text-fontColor-50/50'>
